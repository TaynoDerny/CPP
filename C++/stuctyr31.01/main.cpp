...
void search_by_name(const VIDEO_SHOP* shop, int size) {
    if (size == 0) {
        cout << "\nКаталог пуст!" << endl;
        return;
    }
...
void search_by_genre(const VIDEO_SHOP* shop, int size) {
    if (size == 0) {
        cout << "\nКаталог пуст!" << endl;
        return;
    }
...
void search_by_director(const VIDEO_SHOP* shop, int size) {
    if (size == 0) {
        cout << "\nКаталог пуст!" << endl;
        return;
    }
...
void most_popular_in_genre(const VIDEO_SHOP* shop, int size) {
    if (size == 0) {
        cout << "\nКаталог пуст!" << endl;
        return;
    }
...
int main() {
    ...
    // Инициализация начальными данными (опционально)
    ...
    do {
        ...
        switch (choice) {
            ...
            case 2:
                ...
                break;
            case 3:
                search_by_name(shop, size);
                break;
            case 4:
                search_by_genre(shop, size);
                break;
            case 5:
                search_by_director(shop, size);
                break;
            case 6:
                most_popular_in_genre(shop, size);
                break;
            case 7:
